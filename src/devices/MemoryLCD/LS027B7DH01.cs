...
namespace Iot.Device.MemoryLcd
{
    ...
    public class LS027B7DH01 : LSxxxB7DHxx
    {
        ...
        public LS027B7DH01(SpiDevice spi, GpioController gpio = null, PinNumberingScheme pinNumberingScheme = PinNumberingScheme.Logical, bool shouldDispose = true, int scs = -1, int disp = -1, int extcomin = -1)
            : base(spi, gpio, pinNumberingScheme, shouldDispose, scs, disp, extcomin)
        {
        }
