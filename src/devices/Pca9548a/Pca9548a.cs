...
namespace Iot.Device.Pca9548a
{
    /// <summary>
    /// A general purpose parallel I/O expansion for I2C applications.
    /// </summary>
    public class Pca9548a : IDisposable
    {
        ...
        /// <summary>
        /// Initializes new instance of Pca9548a.
        /// A general purpose parallel I/O expansion for I2C applications.
        /// </summary>
        ...
        public Pca9548a(I2cDevice i2cDevice, int? interrupt = null, GpioController? gpioController = null, bool shouldDispose = true)
        {
